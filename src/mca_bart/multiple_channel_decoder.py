...
from .multiple_channel_attention import pooolingMultipleChannelAttention


class SelfAttention(nn.Module):
    """Multi-headed attention from 'Attention Is All You Need' paper. Copied from BartAttention"""
...
class MultiChannelDecoderLayer(nn.Module):
    """ Copied from BartDecoderLayer"""
    ...
    def __init__(self, config):
        ...
        self.encoder_attn = pooolingMultipleChannelAttention(
            self.embed_dim,
    ...
    torch.FloatTensor]]]:
        ...
        Args:
            ...
            encoder_hidden_states (`torch.FloatTensor`):
                cross attention input to the layer of shape `(num_channel, batch, seq_len, embed_dim)`
